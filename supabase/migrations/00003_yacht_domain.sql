-- Migration: Yacht domain tables
-- New tables:
--   public.yachts
--   public.yacht_specifications
--   public.yacht_locations
--
-- NOTE: RLS helper function public.current_user_role() was already created in
--       00002_rls_fixes.sql. All RLS policies below depend on it.

-- ============================================================
-- 1. Yacht domain enums
-- ============================================================
